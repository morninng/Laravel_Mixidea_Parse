...
Create_Event.prototype.create_round_game = function(request, response,i){
  ...
  console.log("create round game is called");
  var self = this;
...
//  mixidea_game.set("date_time", self.param.event_date);
  ...
  mixidea_game.save().then(function(game_obj){
    ...
    console.log( i + "th round has been created");
    console.log("number of game is " + self.param.game_obj_array.length);

    self.count.number_of_round_created++;
    if(self.count.number_of_round_created == self.param.game_obj_array.length -1){
      self.create_event_hierarchy(request, response);
    }
...
Create_Event.prototype.create_event_hierarchy = function(request, response){

    var self = this;
    console.log("create_event_hierarchy is called")
