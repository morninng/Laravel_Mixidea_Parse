...
//  var WORKER_PATH = 'js/recorderWorker.js';
  var encoderWorker = new Worker('https://mixidea.parseapp.com/recording_test/js/mp3Worker.js');
  ...
  var Recorder = function(source, cfg){
    ...
    var record_worker = new Worker('https://mixidea.parseapp.com/recording_test/js/recorderWorker.js');
        ...
        encoderWorker.onmessage = function(e) {
          if (e.data.cmd == 'data') {
				...
				//console.log ("The Mp3 data " + e.data.buf);
			      ...
			      var audio_new_file = new File([mp3Blob], "jkl.mp3");
			      s3.putObject(
